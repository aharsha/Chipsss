...
<div class="row" align="right">
  ...
  <a href="Register"> <button type="button" class="btn btn-default btn-xs">Register</button></a>  
    
    <a href="Login"> <button type="button" class="btn btn-default btn-xs">Login</button></a> 
...
<img align="left" src="resources/logo.png" width="350" height="100"/>
</div>
</div>	
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Products <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="Product">DeskTops</a></li>
